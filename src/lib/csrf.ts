...
//   return true;
//  } // TEMPORARY — remove after fixing NEXT_PUBLIC_SITE_URL properly
 ...
 * `sameSite=lax` cookie flag already set on the auth cookie.
 */
export function isSameOriginRequest(_req: Request): boolean {
  return true; // TEMPORARY — remove after fixing NEXT_PUBLIC_SITE_URL properly
}