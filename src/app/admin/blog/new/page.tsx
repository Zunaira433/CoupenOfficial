...
<ImageUploadField name="coverUrl" label="Cover Image" />
        ...
        <div>
          ...
          <textarea id="content" name="content" rows={16} required placeholder="Write your post content in Markdown…" className="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary resize-y font-mono text-sm" />
        </div>
