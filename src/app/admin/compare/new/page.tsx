...
if (j.details) {
  setError(JSON.stringify(j.details, null, 2));
} else {
  setError(j.error || "Failed to create comparison");
}
    }
  }
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-8">Add Comparison</h1>
      ...
      <form onSubmit={submit} className="space-y-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-8" noValidate>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input id="itemAName" name="itemAName" type="text" placeholder="e.g. ChatGPT" className="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary" />
          </div>
          <div>
            <label htmlFor="itemBName" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Item B Name</label>
            <input id="itemBName" name="itemBName" type="text" placeholder="e.g. Claude" className="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary" />
          </div>
        </div>

        <div className="grid grid-cols-2 gap-4">
          <div>
            <label htmlFor="brandAId" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Link Brand A <span className="text-gray-400 font-normal">(optional)</span></label>
            <select id="brandAId" name="brandAId" disabled={brandsLoading} defaultValue="" className="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-primary">
              <option value="">None</option>
              {brands.map((b) => <option key={b.id} value={b.id}>{b.name}</option>)}
            </select>
          </div>
          <div>
            <label htmlFor="brandBId" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Link Brand B <span className="text-gray-400 font-normal">(optional)</span></label>
            <select id="brandBId" name="brandBId" disabled={brandsLoading} defaultValue="" className="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-primary">
              <option value="">None</option>
              {brands.map((b) => <option key={b.id} value={b.id}>{b.name}</option>)}
            </select>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-6 pt-2 border-t border-gray-100 dark:border-gray-800">
          <div className="space-y-4">
            ...
            <div>
              ...
              <input id="bestForA" name="bestForA" type="text" placeholder="e.g. Developers needing plugins" className="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary" />
            </div>
            <CtaLinkField title="Link for Option A" linkName="ctaLinkA" labelName="ctaLabelA" />
          </div>
          <div className="space-y-4">
            ...
            <div>
              ...
              <input id="bestForB" name="bestForB" type="text" placeholder="e.g. Writers needing long context" className="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary" />
            </div>
            <CtaLinkField title="Link for Option B" linkName="ctaLinkB" labelName="ctaLabelB" />
          </div>
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Overall recommendation in a couple sentences..."
